...
def if_not_matched(disease):
		...
		print("")
		print("***** MOST PROBABLE DISEASE THAT YOU HAVE IS ***** %s\n" %(id_disease))
		print("***** SHORT DESCRIPTION OF DISEASE IS GIVEN BELOW *****\n")
		print(disease_details+"\n")
		print("***** COMMON MEDICATIONS AND PROCEDURES SUGGESTED BY OTHER REAL DOCTORS ***** \n")
		print(treatments+"\n")
...
class Greetings(KnowledgeEngine):
	...
	def _initial_action(self):
		print("")
		print("Hi! I am Dr.Jass, I am here to help you make your health better.")
...
if __name__ == "__main__":
	...
	while(1):
		...
		engine.run()  # Run it!
		print("WOULD YOU LIKE TO DIAGNOSE SOME MORE SYMPTOMS?")
		if input() == "no":
			exit()
		#print(engine.facts)
